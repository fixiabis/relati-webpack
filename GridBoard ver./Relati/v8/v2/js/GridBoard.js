...
var Grid = /** @class */ (function () {
    ...
    Grid.convertDirection = function (directions) {
        ...
        for (var i = 0; i < simplifyDirections.length; i++) {
            ...
            if (directions.match(simplifyDirection)) {
                for (var _i = 0, _a = originalDirections[i]; _i < _a.length; _i++) {
                    var originalDirection = _a[_i];
                    result = result.concat(Grid.convertDirection(directions.replace(simplifyDirection, originalDirection)));
                }
                return result;
            }
        }
