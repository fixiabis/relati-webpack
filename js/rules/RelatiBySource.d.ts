...
/** 通用連結來源狀態 */
export declare var RelatiCommonSourceStatus: RelatiRoleStatus.RelatiCommon[];
/** 通用連結來源規則 */
export declare var RelatiCommonBySource: RelatiSourcePathRule;
/** 一般連結來源狀態 */
export declare var RelatiNormalSourceStatus: RelatiRoleStatus.RelatiNormal[];
/** 一般連結來源規則 */
export declare var RelatiNormalBySource: RelatiSourcePathRule;
/** 遠程連結來源狀態 */
export declare var RelatiRemoteSourceStatus: RelatiRoleStatus.RelatiRemote[];
/** 遠程連結來源規則 */
export declare var RelatiRemoteBySource: RelatiSourcePathRule;
/** 遠程一般連結來源狀態 */
export declare var RelatiRemoteNormalSourceStatus: RelatiRoleStatus.RelatiRemoteNormal[];
/** 遠程一般連結來源規則 */
export declare var RelatiRemoteNormalBySource: RelatiSourcePathRule;
/** 遠程穩定連結來源狀態 */
export declare var RelatiRemoteStableSourceStatus: RelatiRoleStatus.RelatiRemoteStable[];
/** 遠程穩定連結來源規則 */
