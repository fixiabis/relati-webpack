(function (factory) {
    ...
    class NormalRole extends RelatiRole_1.RelatiRole {
        constructor(grid, owner, type) {
            super(grid, owner, type);
            this.params["relati-source"] = RelatiProtocol_1.RelatiProtocolParams.RelatiNormal;
            this.params["relati-target"] = RelatiProtocol_1.RelatiProtocolParams.RelatiNormal;
            if (type == "leader") {
