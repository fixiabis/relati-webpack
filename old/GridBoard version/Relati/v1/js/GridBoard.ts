(function () {
    ...
    class Grid {
        ...
        query(command: string): Grid | Grid[] {
            ...
            if (command.match(/\d+/)) {
                var unit: number = parseInt(command.match(/\d+/)[0]);
                var dir = command;
                command = "";
    ...
    GridBoard.prototype.Grid = Grid;
    GridBoard.prototype.GridBoardViewer = GridBoardViewer;
